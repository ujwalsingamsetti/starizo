  ...
  build: {
    rollupOptions: {
      input: {
        ...
        plant: resolve(__dirname, 'plant.html'),
        'food-beverage': resolve(__dirname, 'food-beverage.html'),
        'cosmetics-personal-care': resolve(__dirname, 'cosmetics-personal-care.html'),
      },
    },
  },
});
